...
class LUTRandomizerPro:
    ...
    def _create_identity_cube(self, size: int) -> np.ndarray:
        return create_identity_cube(size)
    ...
    def save_cube(self, cube_data: np.ndarray, file_path: str, name: str = "RandomLUT") -> str:
    ...
    def apply_lut_to_image_fast(image_array: np.ndarray, lut_cube: np.ndarray) -> np.ndarray:
        """Apply LUT with shared vectorized trilinear interpolation."""
